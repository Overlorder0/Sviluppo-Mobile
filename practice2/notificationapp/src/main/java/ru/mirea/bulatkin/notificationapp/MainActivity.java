//Ура Ура древний андроид не справляется с нагрузкой на уведомления
//Ура Ура надо ставить не ниже 5го на эмулятор, иначе он и будет крашится
//Потому что желейный боба на такое не расчитан


package ru.mirea.bulatkin.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    private static final String CHANNEL_ID = "ru.mirea.bulatkin.notification.ANDROID";
